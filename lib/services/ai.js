...
function stripThinking(content) {
  ...
  // MiniMax reasoning models can place private reasoning before the JSON
  // response. Remove complete reasoning blocks before parsing the payload.
  out = out.replace(/<think\b[^>]*>[\s\S]*?<\/think\s*>/gi, '').trim()
