...
// Reuse a single client per process so Next hot reloads and repeated tests do not
// create a new pool on every import.
function getUri() {
...
export async function getDb() {
  ...
  // The same process can switch databases in tests, so cache both the handle and name.
