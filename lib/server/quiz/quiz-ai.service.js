...
import { aiChatJSON } from '@/lib/services/ai.js'
...
function buildGenerationMessages(input) {
  ...
  return {
    system: [
      ...
      'Fill-in-the-blank questions must use an empty options array.',
      'Do not generate short-answer or one-line-answer questions.',
    ...
    user: JSON.stringify({
      ...
      count: input.count,
      requirements: {
        mixedMeans: 'Use a useful mix of mcq and blank types.',
